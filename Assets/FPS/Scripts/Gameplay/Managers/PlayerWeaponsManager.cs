...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour, IAimHighWeaponInventory
    {
        ...
        public List<AimHighWeaponController> StartingWeapons = new List<AimHighWeaponController>();
        ...
        public UnityAction<AimHighWeaponController> OnSwitchedToWeapon;
        public UnityAction<AimHighWeaponController, int> OnAddedWeapon;
        public UnityAction<AimHighWeaponController, int> OnRemovedWeapon;

        AimHighWeaponController[] m_WeaponSlots = new AimHighWeaponController[9]; // 9 available weapon slots
        ...
        void Update()
        {
            if (m_AimHighShopManager != null && m_AimHighShopManager.IsShopOpen)
            {
            ...
            // shoot handling
            AimHighWeaponController activeWeapon = GetActiveWeapon();
            ...
            if (activeWeapon)
            {
                IsPointingAtEnemy = activeWeapon.HasTargetInsideCrosshair(m_PlayerCharacterController.PlayerCamera);
            }
        }
        ...
        public void SwitchToWeaponIndex(int newWeaponIndex, bool force = false)
        {
            if (force || (newWeaponIndex != ActiveWeaponIndex && newWeaponIndex >= 0))
            {
                ...
                if (GetActiveWeapon() == null)
                {
                    ...
                    AimHighWeaponController newWeapon = GetWeaponAtSlotIndex(m_WeaponSwitchNewWeaponIndex);
        ...
        public AimHighWeaponController HasWeapon(AimHighWeaponController weaponPrefab)
        {
        ...
        void UpdateWeaponSwitching()
        {
            ...
            if (switchingTimeFactor >= 1f)
            {
                if (m_WeaponSwitchState == WeaponSwitchState.PutDownPrevious)
                {
                    ...
                    AimHighWeaponController oldWeapon = GetWeaponAtSlotIndex(ActiveWeaponIndex);
                    if (oldWeapon != null)
                    {
                    ...
                    // Activate new weapon
                    AimHighWeaponController newWeapon = GetWeaponAtSlotIndex(ActiveWeaponIndex);
                    if (OnSwitchedToWeapon != null)
                    {
                        OnSwitchedToWeapon.Invoke(newWeapon);
                    }
        ...
        public bool AddWeapon(AimHighWeaponController weaponPrefab)
        {
            ...
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                ...
                if (m_WeaponSlots[i] == null)
                {
                    ...
                    AimHighWeaponController weaponInstance = Instantiate(weaponPrefab, WeaponParentSocket);
                    ...
                    weaponInstance.ReferenceCamera = m_PlayerCharacterController.PlayerCamera;
        ...
        public bool RemoveWeapon(AimHighWeaponController weaponInstance)
        {
        ...
        public AimHighWeaponController GetActiveWeapon()
        {
            return GetWeaponAtSlotIndex(ActiveWeaponIndex);
        }

        public void SetPassiveAmmoRefill(bool enabled)
        {
        }

        public AimHighWeaponController GetShopWeapon()
        {
            return GetActiveWeapon();
        }

        public void PrepareAimHighWeapon(int clipSize, int reserveAmmo)
        {
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                if (m_WeaponSlots[i] != null)
                {
                    m_WeaponSlots[i].SetMagazineDefaults(clipSize, reserveAmmo);
                }
            }
        }

        public void RefillWeaponsForNewRound()
        {
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                if (m_WeaponSlots[i] != null)
                {
                    m_WeaponSlots[i].RefillMagazineFromReserve();
                }
            }
        }

        public AimHighWeaponController GetWeaponAtSlotIndex(int index)
        {
