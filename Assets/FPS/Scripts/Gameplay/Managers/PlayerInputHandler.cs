...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            m_FireInputWasHeld = CanProcessInput() && m_FireAction != null && m_FireAction.IsPressed();
        }

        public bool CanProcessInput()
        {
            bool shopIsOpen = m_AimHighShopManager != null && m_AimHighShopManager.IsShopOpen;
            return Cursor.lockState == CursorLockMode.Locked && !m_GameFlowManager.GameIsEnding && !shopIsOpen;
        }
